...
export const NAVIGATION=[
 ...
 {section:'Lean Six Sigma',groups:[
  ...
  {id:'analyze',name:'Analyze',color:'var(--orange)',subgroups:[{label:'Documents',items:[doc('hypothesis-plan','Hypothesis Test Plan')]},{label:'Tools',items:[tool('hypothesis','Hypothesis Testing','/hypothesis'),tool('pareto','Pareto Chart'),tool('scatter','Scatter Plot'),tool('boxplot','Box Plot'),tool('fishbone','Fishbone Diagram'),tool('fmea-analyze','FMEA','/tool/fmea'),tool('multivari','Multi-Vari Chart'),tool('correlation','Correlation Matrix'),tool('regression','Regression'),tool('multiregression','Multiple Regression'),tool('logistic','Logistic Regression'),tool('anova','ANOVA'),tool('effect-size','Effect Size Calculators')]}]},
  ...
  {id:'control',name:'Control',color:'var(--cyan)',subgroups:[{label:'Documents',items:[doc('control-plan','Control Plan'),doc('reaction-plan','Reaction Plan'),doc('monitoring-plan','Monitoring Plan'),doc('audit-checklist','Audit Checklist'),doc('lessons-learned','Lessons Learned'),doc('project-closure','Project Closure')]},{label:'Tools',items:[tool('control-chart-control','Control Chart','/tool/control-chart'),tool('attribute-chart-control','Attribute Charts','/tool/attribute-chart'),tool('run-chart-control','Run Chart','/tool/run-chart')]}]},
 ]},
