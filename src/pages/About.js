...
const FAQS = [
  {
    q: 'Do I need a background in statistics to use Aureqin?',
    a: 'No. Aureqin supports quality professionals, engineers, operations leaders, project teams, and students with guided workflows and plain-language explanations. You remain in control while the platform simplifies technical complexity.'
  },
  {
    q: 'What makes Aureqin different from standalone statistical software?',
    a: 'Standalone tools focus on isolated analyses. Aureqin connects operational excellence and project execution: projects, datasets, analyses, evidence, interactive documents, and reports remain part of one workspace. Future intelligence features are designed to build on that connected foundation.'
  },
  {
  ...
  
  {
    ...
    a: 'Yes. Aureqin is built as a complete project workspace. Organize multiple initiatives, store datasets, generate reports, maintain project history, and keep analyses and documentation connected.'
  },
  {
  ...
  {
    q: 'Is Aureqin suitable for regulated industries?',
    a: 'Aureqin supports standard improvement methods used across regulated environments. Organizations operating under FDA, ISO, GMP, or similar requirements should validate software use according to their own quality and compliance procedures.'
  },
  {
  ...
  },
  {
    ...
    a: 'Absolutely. Aureqin is under continuous development. New workspaces, statistical methods, visualizations, and project management capabilities are shaped by customer feedback and industry practice.'
  },
  {
    q: 'Is Aureqin suitable for students?',
    a: "Yes. Whether you're learning Lean Six Sigma, project management, completing coursework, or working on your first improvement project, Aureqin provides structured workflows for professional-quality work."
  },
  {
  ...
  {
    q: 'How does Aureqin simplify the tool stack?',
  ...
  return (
    <div className="about-page">
      ...
      <section className="about-card mission-card about-mission-full">
        <h2>Our Mission</h2>
        <p>
          At Aureqin, our mission is to advance operational excellence through an
      ...
      <section className="about-tools-section">
        ...
        <p>Aureqin connects statistical tools with Lean Six Sigma, project management, datasets, evidence, documents, and reporting.</p>
      ...
      <section className="about-disclaimer">
        <h2>Disclaimer</h2>
        <p>
          Aureqin is provided as-is for professional and educational use. All statistical
