...
export default function ProjectCharter() {
  ...
  const saveNow = () => { updateProject(id, { charter: { ...charter, schemaVersion: PROJECT_CHARTER_SCHEMA_VERSION, updatedAt: new Date().toISOString() } }); setSaveState('saved'); };
