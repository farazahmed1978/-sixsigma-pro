...
export default function SupabaseSetupGate({children}){
  ...
  return <div className="supabase-setup-screen" role="status">
    <section>
      <Link to="/"><img src={logo} alt="AXENTRA"/></Link>
      <span>DEVELOPMENT CONFIGURATION</span>
      <h1>Supabase has not been configured yet.</h1>
      <p>Account creation and sign-in require a Supabase project URL and public anonymous key. The rest of Axentra and all existing local data remain unchanged.</p>
