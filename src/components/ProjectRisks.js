...
export default function ProjectRisks({project}){
  ...
  return <section className="pm-risks" aria-labelledby="pm-risks-title">
    ...
    {attachTarget&&<AssetUploadModal project={project} defaultLink={{artifactType:'risk',artifactId:attachTarget.id,artifactLabel:attachTarget.title}} onClose={()=>setAttachTarget(null)} onUploaded={()=>setAttachTarget(null)} />}
  </section>;
}
