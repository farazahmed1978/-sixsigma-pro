...
import {lifecycleForProject,resolveProjectSuiteId,sortByLifecycle} from '../foundation/lifecycle';
...
export const sortReportItemsByPhase=(items,project)=>sortByLifecycle(items,lifecycleForProject(project||items.find(item=>item.suiteId||item.methodology)||{}));
